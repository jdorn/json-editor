...
// If explicitly set to 'checkbox', use that
return"checkbox"===a.format||a.options&&a.options.checkbox?"checkbox":f.plugins.selectize.enable&&!f.plugins.selectize.multiArrayOnly?"selectize":"select"}),
...
f.defaults.resolvers.unshift(function(a){if(a.enumSource)return f.plugins.selectize.enable&&!f.plugins.selectize.multiArrayOnly?"selectize":"select"}),
// Use the `enum` or `select` editors for schemas with enumerated properties
f.defaults.resolvers.unshift(function(a){if(a["enum"]){if("array"===a.type||"object"===a.type)return"enum";if("number"===a.type||"integer"===a.type||"string"===a.type)return f.plugins.selectize.enable&&!f.plugins.selectize.multiArrayOnly?"selectize":"select"}}),
